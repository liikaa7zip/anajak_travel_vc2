<template>
  <div class="min-h-screen bg-white w-full">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center max-w-none ">
          <div class="space-y-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button
                @click="explore"
                class="bg-purple-600 text-white px-8 py-2 rounded-full hover:bg-purple-700 transition-colors text-lg font-medium"
              >Explore</button>
              <button
                class="border-2 border-purple-600 text-purple-600 px-8 py-2 rounded-full hover:bg-purple-50 transition-colors text-lg font-medium"
              >Learn More</button>
            </div>
          </div>
    ...
    <section class="py-16 bg-purple-100 w-full lg:px-16">
      <div class="w-full mb-4">
        ...
        >
          ...
          <a href="#" class="text-purple-600 hover:text-purple-700 font-medium text-lg">See all</a>
        </div>
          ...
          <div class="space-y-8">
            ...
            <div class="space-y-6">
              <div
                ...
                :key="feature.id"
                class="flex items-start bg-white-40 shadow-md space-x-6 p-6 rounded-xl hover:bg-gray-50 hover:shadow-md transition-all"
              >
                <div
                ...
                <div>
                  <h3 class="font-bold text-gray-800 mb-3 text-lg">{{ feature.name }}</h3>
    ...
    <!-- Footer -->
    <footer class=" lg:py-20 bg-bl px-4 ">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-4 w-full">
        <div class="lg:col-span-1 lg:px-16 ">
          <div class="flex items-center space-x-2 mb-6">
            ...
            />
            <span class="text-xl lg:text-2xl font-bold text-gray-800">Anajak Travel</span>
          </div>
          <p
            class="text-gray-600 mb-8 leading-relaxed"
          >Anajak Travel is Cambodia's travel and lifestyle app, we provide you with access to discover and purchase different type of travel needs.</p>
        </div>

        <div>
          <h3 class="font-bold text-gray-800 mb-6 text-lg">Quick Links</h3>
          <ul class="space-y-3">
            <li>
              <a
                href="#"
            ...
            <li>
              <a href="#" class="text-gray-600 hover:text-purple-600 transition-colors">Contact Us</a>
            </li>
            <li>
              <a
                href="#"
        ...
        <div>
          <h3 class="font-bold text-gray-800 mb-6 text-lg">About</h3>
          <ul class="space-y-3">
            <li>
              <a href="/travel-bookings/flights" class="text-gray-600 hover:text-purple-600 transition-colors">Flight Reservation</a>
            </li>
            <li>
              <a href="/travel-bookings/cars" class="text-gray-600 hover:text-purple-600 transition-colors">Car Rental</a>
            </li>
            <li>
              <a href="/travel-bookings/boats" class="text-gray-600 hover:text-purple-600 transition-colors">Boat Tickets</a>
            </li>
            <li>
              <a href="/travel-bookings/bus" class="text-gray-600 hover:text-purple-600 transition-colors">Bus Tickets</a>
            </li>
            <li>
              <a href="/travel-bookings/hotels" class="text-gray-600 hover:text-purple-600 transition-colors">Hotel Booking</a>
            </li>
            <li>
              <a href="/food/restaurants" class="text-gray-600 hover:text-purple-600 transition-colors">Restaurant Reservations</a>
            </li>
          </ul>
        </div>

        <div>
          <h3 class="font-bold text-gray-800 mb-6 text-lg">Cambodia Info</h3>
          <ul class="space-y-3">
            <li>
              <a href="/blog" class="text-gray-600 hover:text-purple-600 transition-colors">Blog</a>
            </li>
            <li>
              <a
                href="#"
      ...
      <!-- Bottom Bar -->
      <div class="max-w-full bg-gray-200 my-14 mb-0 py-4 bg-blac">

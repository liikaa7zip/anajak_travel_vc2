  ...
  <div class="font-sans bg-gray-100 text-gray-900 min-h-screen">
    ...
    <section class="relative w-full h-80 sm:h-96">
      ...
      <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center px-6">
        <h1 class="text-white text-3xl sm:text-6xl font-bold">
          <i class="fa-solid fa-location-dot"></i>Kampong Thom <br />
    ...
    <section class="pt-12 pb-6 pr-16 pl-16">
      <div class="bg-white rounded-lg shadow p-4 flex flex-col sm:flex-row items-start justify-between gap-4">
        <div class="max-w-xl">
          <h2 class="text-2xl font-semibold mb-2 text-purple-600">About Kampong Thom</h2>
          <p class="text-sm text-gray-700">
            Kampong Thom is one of Cambodia’s largest provinces by land area and lies at the heart of the country. The name means “Great Port” in Khmer, referring to its historical role as a major trading hub along the Stung Saen River, a tributary of the Tonlé Sap. Today, Kampong Thom is known for its natural beauty, rural charm, and remarkable archaeological heritage.

            This province is home to Sambor Prei Kuk, a UNESCO World Heritage Site and one of Southeast Asia’s oldest temple complexes, dating back to the pre-Angkorian Chenla period (7th century). Its central location also makes it an important link between Phnom Penh and Siem Reap.
          </p>
        </div>
        <img

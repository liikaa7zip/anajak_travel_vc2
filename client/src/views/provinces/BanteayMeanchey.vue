<template>
  <div class="font-sans bg-gray-100 text-gray-900 min-h-screen">
    ...
    <section class="relative w-full h-80">
      ...
      <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center px-6">
        <h1 class="text-white text-3xl sm:text-6xl font-bold">
          📍Banteay Meanchey <br />
          <span class="text-4xl ml-6">Province</span>
        </h1>
      </div>
    </section>

    <!-- About Section -->
    <section class="pt-10 pr-20 pl-20 pb-10">
      <div class="flex justify-between">
        <div class="max-w-xl">
          <h2 class="text-3xl font-semibold mb-2">About Banteay Meanchey</h2>
          <p class="text-2sm text-gray-700">
            This province is in the northwest of Cambodia. It’s close to Thailand and has old temples and quiet countryside. The city is called Sisophon.
          </p>
        </div>
        <img
          src="https://upload.wikimedia.org/wikipedia/commons/1/18/Cambodia_Banteay_Meanchey.png"
          alt="Banteay Meanchey Map"
          class="w-full h-auto max-w-xs rounded shadow"
        />
      </div>
    </section>
    ...
    <!-- Top Attractions -->
    <section class="pt-10 pr-20 pl-20 pb-10">
      <h2 class="text-3xl font-semibold mb-4">Top Attractions</h2>
    ...
    <section class="pt-10 pr-20 pl-20 pb-10 grid sm:grid-cols-2 gap-6 justify-between">
      <div>
        <h2 class="text-3xl font-semibold mb-2">Things to Do</h2>
        <ul class="list-disc pl-5 text-2sm text-gray-700">
          <li>Visit Banteay Chhmar</li>
          <li>Go bird-watching at the Ang Trapeang Thmor lake</li>
          <li>Explore Sisophon Market to see local life</li>
        </ul>
      </div>
      <div>
        <h2 class="text-3xl font-semibold mb-2">Travel Tips</h2>
        <ul class="list-disc pl-5 text-2sm text-gray-700">
          <li>Best time: Nov – Apr</li>

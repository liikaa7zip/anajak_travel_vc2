      ...
      <table class="min-w-full bg-white border border-gray-200 rounded-lg text-sm">
        <thead class="bg-purple-100 text-purple-900 text-left">
          <tr>
            ...
            <th class="py-3 px-5 border-b">Booked On</th>
            <th class="py-3 px-5 border-b">From</th>
            <th class="py-3 px-5 border-b">To</th>
            <th class="py-3 px-5 border-b">Airline</th>
            <th class="py-3 px-5 border-b">Class</th>
        ...
        <tbody>
          ...
          >
            ...
            <td class="py-3 px-5 border-b">{{ booking.airline }}</td>
            <td class="py-3 px-5 border-b">{{ booking.classType }}</td>
...
const confirmCancel = async (id) => {
  ...
  try {
    await axios.put(`http://localhost:5000/api/flightbookings/${id}/cancel`)

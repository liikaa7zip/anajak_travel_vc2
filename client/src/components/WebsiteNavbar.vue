<template>
  <nav class="bg-white shadow-md border-b border-gray-200">
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
              <router-link to="/resturant" class="dropdown-item"
    ...
    <div v-if="isMenuOpen" class="md:hidden px-4 pb-4 bg-gray-100 space-y-2">
      ...
      <router-link to="/guide" class="mobile-nav-link"
        >Traveling Guide</router-link
      >
      ...
      <div>
        <button
          ...
          class="mobile-nav-link flex justify-between w-full items-center"
        >
          Travel Bookings
          <svg
            class="w-4 h-4"
        ...
        <div v-if="isMobileDropdownOpen" class="ml-4 mt-1 space-y-1">
          ...
          <router-link to="/flights" class="mobile-sub-link"
            >✈️ Flight Reservation</router-link
          >
          <router-link to="/cars" class="mobile-sub-link"
            >🚗 Car Rental</router-link
          >
          <router-link to="/bus" class="mobile-sub-link"
            >🚌 Bus Tickets</router-link
          >
          <router-link to="/boats" class="mobile-sub-link"
            >⛴️ Boat Tickets</router-link
          >

          <h3 class="text-xs text-blue-600 font-semibold mt-2">
            HOTELS & DINING
          </h3>
          <router-link to="/hotel" class="dropdown-item"
            >🏨 Hotel Booking</router-link
      ...
      <router-link
        to="/signup"
        class="block py-2 mt-2 bg-purple-600 text-white text-center rounded-full hover:bg-purple-700 transition"
        >Sign Up</router-link
      >
    </div>
  </nav>

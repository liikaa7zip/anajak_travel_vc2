<template>
  <nav class="bg-white shadow-md border-b border-gray-200 w-full z-50 relative">
    <div
      class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16"
    >
      <!-- Logo -->
      <router-link
        to="/"
          ...
          <transition name="fade">
            ...
            >
              <div>
                ...
                <router-link to="/FlightReservation" class="dropdown-item"
                  >✈️ Flight Reservation</router-link
                >
                <router-link to="/CarRental" class="dropdown-item"
                  >🚗 Car Rental</router-link
                >
                <router-link to="/Bustickets" class="dropdown-item"
                  >🚌 Bus Tickets</router-link
                >
                <router-link to="/Boatickets" class="dropdown-item"
                  >⛴️ Boat Tickets</router-link
                >
              </div>
              <div>
                <h3 class="text-blue-600 font-semibold text-sm mb-3">
                ...
                >
                <router-link to="/province" class="dropdown-item"
                  >🍽️ Restaurant Reservations</router-link
                >
              </div>
              <div>
                <h3 class="text-blue-600 font-semibold text-sm mb-3">
                ...
                <router-link to="/user-plan" class="dropdown-item"
                  >🗺️ User Plan</router-link
                >
                <router-link to="/TravelItinerary" class="dropdown-item"
                  >📅 Travel Itinerary</router-link
                >
              </div>
            </div>
          </transition>
      ...
      <div class="flex items-center space-x-4">
        ...
        <template v-if="isInitialized">
          ...
          >
            <button
              class="flex items-center gap-3 px-3 py-2 rounded-full hover:bg-gray-100 transition-all group"
            >
              <!-- Avatar -->
              <div
                class="w-10 h-10 bg-purple-600 rounded-full overflow-hidden flex items-center justify-center"
              >
                <img
              ...
              <!-- Chevron -->
              <svg
                class="w-4 h-4 text-gray-500 group-hover:text-purple-600 transition"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              >
                ...
                <div class="px-5 py-4 bg-gray-50 border-b border-gray-200">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-10 h-10 rounded-full bg-purple-600 flex items-center justify-center overflow-hidden"
                    >
                      <img
                        v-if="userProfile.avatar"
                        :src="userProfile.avatar"
                ...
                <div class="py-1">
                  ...
                  <router-link
                    v-if="isReturantowner"
                    to="/restaurant_owner/fooddashboard"
                    class="dropdown-item"
                  >
